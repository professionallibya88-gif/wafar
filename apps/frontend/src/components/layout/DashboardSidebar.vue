<template>
  <aside
    class="sidebar-menu dashboard-sidebar overflow-hidden flex flex-col fixed inset-y-0 right-0 z-50 transition-transform duration-300 lg:inset-y-3 lg:right-3 lg:rounded-[1.75rem]"
    :class="[
